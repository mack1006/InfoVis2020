function Isosurfaces( volume, isovalue,light,camera,numcolor)
{
	...
	uniforms: {
		...
		color_isovalue: { type: 'v3', value: color },
	...
	var index_v0 = v0.x + v0.y*lines + v0.z*slices; 
	var index_v1 = v1.x + v1.y*lines + v1.z*slices;
	var val_v0 = volume.values[index_v0][0]; 
	var val_v1 = volume.values[index_v1][0];

	//console.log("v0: " + val_v0 + " v1: "+val_v1 + " s: "+ s);
	var int_vec = new THREE.Vector3().addVectors( v0.multiplyScalar(Math.abs(val_v1-s)), v1.multiplyScalar(Math.abs(val_v0-s))).divideScalar(Math.abs(val_v0-val_v1));
